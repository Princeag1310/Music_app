        ...
        <div className="w-full">
          ...
          {passwordValue && passwordValidation && (
            <div className="mt-2 text-xs space-y-1">
              ...
              >
                {passwordValidation.requirements?.minLength ? "✓" : "✗"} Minimum
                7 characters
              </div>
              <div
                className={
              ...
              >
                {passwordValidation.requirements?.hasLetter ? "✓" : "✗"} At
                least one letter
              </div>
              <div
                className={
              ...
              >
                {passwordValidation.requirements?.hasNumbers ? "✓" : "✗"} At
                least one number
              </div>
              <div
                className={
              ...
              >
                {passwordValidation.requirements?.hasSpecialChar ? "✓" : "✗"} At
